(ns cspbox.runtime.sys.emit.inout.inject
  (:require [cspbox.runtime.sys.emit.inout.chan :refer [get-or-add]]
            [cspbox.runtime.sys.utils.util :refer [pickup  get-fn-var]]
